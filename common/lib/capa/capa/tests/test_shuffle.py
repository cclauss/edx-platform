        ...
        xml_str = textwrap.dedent("""
            ...
            <choicetextresponse>
              <{option_group} shuffle="true">
                <choice correct="false">Alpha <numtolerance_input answer="A" /></choice>
                <choice correct="false">Bravo <numtolerance_input answer="B" /></choice>
                <choice correct="true">Charlie <numtolerance_input answer="C" /></choice>
                <choice correct="false">Delta <numtolerance_input answer="D" /></choice>
              </{option_group}>
            </choicetextresponse>
            </problem>
